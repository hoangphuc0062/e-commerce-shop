        ...
        <div className="flex flex-col items-center bg-[#F4F6F8] mb-5">
            ...
            <div className="flex center justify-center w-full py-5">
                ...
                <div className="text-red-600 font-bold px-4 md:px-10 cursor-pointer">
                    <span className="text-gray-400" onClick={() => window.location.href = '/checkout'}>2. THANH TOÁN</span>
                </div>
            </div>
                    ...
                    <div className="item-info flex items-center py-5">
                        ...
                        <div className="ml-4 flex flex-col justify-center ">
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <div className="flex items-center">
                                    <p className="text-red-500 text-lg">4.790.000đ <del className="text-black">4.990.000đ</del></p>
                                </div>
                                <p className="hidden md:block" style={{ marginLeft: '120px' }}>Số lượng : 1</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="customer-info w-full flex justify-center">
                <div className="w-full max-w-[600px] bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="flex items-center mt-3">
                        ...
                        <label htmlFor="newsletter" className="text-sm text-gray-800">Nhận email thông báo và ưu đãi từ Voi Tây Nguyên</label>
                    </div>
                </div>
            </div>

            <p className="text-main font-semibold md:mr-80 mt-8">THÔNG TIN NHẬN HÀNG</p>
            <div className="w-full flex justify-center mt-2">
                <div className="w-full max-w-[600px] bg-white p-6 rounded-lg shadow-md mb-5">
                    <div className="flex items-center space-x-6 mb-4">
                        <label className="flex items-center">
                            <input 
                                ...
                                className="mr-2" />Nhận tại cửa hàng
                        </label>
                        <label className="flex items-center">
                            <input 
                                type="radio" 
                                ...
                                className="mr-2" />Giao hàng tận nơi
                        </label>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Chọn quận/huyện</label>
                            <select 
                                value={district} 
                    ...
                    {deliveryOption === 'storePickup' && (
                        <div className="mb-4 relative">
                            <label className="block text-sm font-medium text-gray-700">Tìm kiếm địa chỉ cửa hàng</label>
                            <input 
                                type="text" 
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700">Ghi chú khác (nếu có)</label>
                        <input 
                            type="text" 
                            placeholder="Nhập ghi chú" 
                            className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm py-1"/>
                    </div>
                    <p className="text-sm text-gray-500"> Mẹo: Bạn có thể cài đặt Số địa chỉ tại Smember để đặt hàng nhanh hơn.</p>
                </div>
            </div>
