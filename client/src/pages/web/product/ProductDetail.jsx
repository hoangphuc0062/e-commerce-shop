...
const ProductDetail = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(0); // Added state for selectedImage
      ...
      {product && (
        <div>
          ...
          <div className="flex flex-col">
            {/* Product Images */}
            <div className="h-96 relative w-1/2 rounded-lg shadow-lg flex items-center justify-center">
              <img
            ...
            <div className="flex overflow-x-auto mt-4">
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`border-2 ${
                    index === selectedImage ? "border-main" : "border-gray-200"
                  } rounded-e-xllg p-1`}
                >
                  <img
                    src={image}
