    ...
    <div className="w-full">
      ...
      <section className="py-16 px-6 flex flex-col md:flex-row items-center gap-8">
        <div className="md:w-1/2">
          ...
          Trung tâm chăm sóc khách hàng là nơi cung cấp hỗ trợ, giải đáp thắc mắc và xử lý các vấn đề liên quan đến sản phẩm hoặc dịch vụ. Các dịch vụ chính bao gồm hỗ trợ kỹ thuật, giải đáp thắc mắc, tiếp nhận phản hồi và khiếu nại, qua các kênh như điện thoại, email, chat trực tuyến. Trung tâm này giúp duy trì mối quan hệ lâu dài với khách hàng và nâng cao uy tín của công ty.
          </p>
      ...
      >
        {reviews.map((review, index) => (
          <SwiperSlide key={index}>
            <p className="font-semibold text-lg">- {review.name}</p> {/* Sử dụng tên đúng */}
          </SwiperSlide>
        ))}
      </Swiper>
    </div>
      ...
      <section className="py-16 px-8 bg-white shadow-lg rounded-lg mb-4">
        ...
        <div className="mt-10">
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openAnswer === 0 ? 'max-h-40' : 'max-h-0'}`}>
              {openAnswer === 0 && (
                <p className="mt-2">
                  Có, tất cả các sản phẩm điện tử mà chúng tôi cung cấp đều đi kèm
                  với chế độ bảo hành từ 6 tháng đến 2 năm, tùy theo từng sản phẩm.
                  Bạn có thể tham khảo chi tiết về bảo hành trên trang sản phẩm.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openAnswer === 1 ? 'max-h-40' : 'max-h-0'}`}>
              {openAnswer === 1 && (
                <p className="mt-2">
                  Bạn có thể dễ dàng đặt mua sản phẩm bằng cách thêm sản phẩm vào
                  giỏ hàng và tiến hành thanh toán thông qua các phương thức thanh
                  toán trực tuyến an toàn mà chúng tôi hỗ trợ, bao gồm thẻ tín
                  dụng, chuyển khoản ngân hàng và thanh toán khi nhận hàng.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            >
              <h3 className="font-semibold">
                Trang web của bạn có cung cấp dịch vụ giao hàng miễn phí không?
              </h3>
              <span className="text-xl">
                {openAnswer === 2 ? "-" : "+"}
              </span>
            </div>
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openAnswer === 2 ? 'max-h-40' : 'max-h-0'}`}>
              {openAnswer === 2 && (
                <p className="mt-2">
                  Có, chúng tôi cung cấp dịch vụ giao hàng miễn phí cho các đơn
                  hàng có giá trị từ 1 triệu đồng trở lên trong khu vực nội thành.
                  Đối với các đơn hàng nhỏ hơn, phí giao hàng sẽ được tính thêm và
                  được thông báo khi thanh toán.
                </p>
              )}
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openAnswer === 3 ? 'max-h-40' : 'max-h-0'}`}>
              {openAnswer === 3 && (
                <p className="mt-2">
                  Nếu gặp bất kỳ vấn đề nào với sản phẩm, bạn có thể liên hệ với
                  trung tâm hỗ trợ khách hàng qua số điện thoại hoặc email của
                  chúng tôi để yêu cầu hỗ trợ hoặc đổi trả sản phẩm trong vòng 7
        ...
        <div className="flex items-center w-full md:w-auto mt-4 md:mt-0 relative">
          <input
            ...
            className={`bg-transparent border-b-2 text-white placeholder-white focus:outline-none px-4 py-2 w-full md:w-80 lg:w-96 transition-all duration-300 ease-in-out ${
              error ? "border-red-500" : "border-white hover:border-yellow-200 focus:border-yellow-200"
            }`}
          />
          <button
