...
export const CouponSchema = Yup.object().shape({
    ...
    productNotApply: Yup.array()
        .of(Yup.string())
        .nullable(), // Optional
    brandNotApply: Yup.array()
        .of(Yup.string())
        .nullable(), // Optional
    collectionNotApply: Yup.array()
        .of(Yup.string())
        .nullable(), // Optional
    categoryNotApply: Yup.array()
        .of(Yup.string())
        .nullable(), // Optional
    quantity: Yup.number()
    ...
    quantityMax: Yup.number()
        ...
        .min(Yup.ref("quantityMin"), "Số lượng tối đa phải lớn hơn số lượng tối thiểu"),
