...
export default function EditCollection({
  ...
  const formik = useFormik({
    initialValues: {
      ...
      titleSEO: collectionData?.titleSEO || "",
      keywordsSEO: collectionData?.keywordsSEO || "",
      descriptionSEO: collectionData?.descriptionSEO || "",
  ...
  return (
    ...
    >
      <DialogTitle id="form-dialog-title">Chỉnh sửa bộ sưu tập</DialogTitle>
